        ...
        {!confirmed ? (
          <>
            <div className="flex items-center justify-between p-6 rounded-2xl bg-card border border-border/50 shadow-lg">
              {["Details", "Address", "Summary", "Payment"].map((label, index) => (
            ...
            {step === 4 && (
              <div className="space-y-4 mt-8">
                ...
                <div className="flex items-center gap-4">
                  <Button variant={paymentMode === "cod" ? "default" : "outline"} onClick={() => setPaymentMode("cod")}>Cash on Delivery</Button>
                  <Button variant={paymentMode === "online" ? "default" : "outline"} onClick={() => setPaymentMode("online")}>Online (coming soon)</Button>
                </div>
                <div className="flex justify-between pt-4">
                  <Button variant="outline" onClick={prev}>Previous</Button>
          ...
          <div className="max-w-lg mx-auto text-center">
            <div className="text-3xl font-serif font-bold mb-4">Order Confirmed!</div>
            <p className="text-muted-foreground">Thank you for shopping with Bio-Scrap. We will contact you shortly to confirm delivery.</p>
