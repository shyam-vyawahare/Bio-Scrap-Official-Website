          ...
          <BrowserRouter>
            ...
            <CartProvider>
              ...
              <a 
                ...
                className="fixed bottom-6 right-6 z-50 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 hover:scale-110 transition-all duration-300 min-w-[56px] min-h-[56px] flex items-center justify-center"
